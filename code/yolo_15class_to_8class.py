...
def modify_files_in_directory(input_directory_path, output_directory_path):
    ...
    class_mapping = {
        ...
        1: 1, # 'car' to 'car'
        2: 2, # 'truck' to 'truck'
        3: 3, # 'cell phone' to 'cell phone'
        7: 4, # 'cone' to 'cone'
        11: 5, # 'helmet' to 'helmet'
        8: 7, # 'hook' to 'hook'
        4: 6, # 'excavator' to 'machinery vehicle'
        5: 6, # 'loader' to 'machinery vehicle'
        6: 6, # 'crane' to 'machinery vehicle'
        9: 6  # 'shovel' to 'machinery vehicle'
    }

    # Set of classes to remove
    classes_to_remove = {10, 12, 13, 14}  # 'payload', 'bar', 'rope', 'barrier'
